...
class MusicPlayer():
    ...
    def make_frame(self):
        bottomframe = Frame(self.root,bg="red")
    ...
    def UplodeSounds(self):
        ...
        self.make_lable(self.sound_name_list)
    ...
    def make_lable(self,sounds):
        ...
        for lable in range(self.num_of_chanells):
            my_lable = Label(self.root, bg=color_list[lable])
            my_lable.pack(side=TOP, fill='x')
